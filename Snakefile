...
rule fix_pdb:
    ...
    shell:
        ...
        bin/modeller-fix-pdb --trim $TMP_DIR/{wildcards.pdbid}.pdb | bin/modeller --modeller-class AllHModel --mdsa-speed very_slow --repeat 3 --best --pdb-path $TMP_DIR > $TMP_DIR/fixed.pdb --log-to-stderr 2>> {log} || true
