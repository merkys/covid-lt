Both the mutant and wild type complex structures are generated using FASPR, with missing hydrogen atoms added via ProMod3 v3.2.1.
...
Produced mutant and wild type complexes are then optimized by running 100 step simulation in gas phase using OpenMM v7.5.1 with CHARMM36 forcefield.
For the simulation, heavy atom positions are restrained using harmonic restraints.
