Figure displays the correlation of different absolute ddG values: estimated using our model ('our'), estimated using a model trained on MutaBind2 terms ('mutabind2') and experimental ('ddG').
